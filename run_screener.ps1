...
& git -C $proj add "docs/report_*.html" "docs/index.html" "docs/screener.html" "docs/data/screener_watch.json" "종목탐색_TOP30.xlsx" 2>&1 | Out-File $out -Append -Encoding utf8
